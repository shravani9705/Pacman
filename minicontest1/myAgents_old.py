...
class ClosestDotAgent(Agent):
    ...
    def findPathToClosestDot(self, gameState):
        ...
        #initpoint = self.initializeK(X, gameState.getNumPacmanAgents())
        "*** YOUR CODE HERE ***"
        ...
        #     if problem.isGoalState(pacmanCurrent[0]):
        #         return pacmanCurrent[1]
        #     if pacmanCurrent[0] not in closedSet:
        #         closedSet.add(pacmanCurrent[0])
        #         succcessors = problem.getSuccessors(pacmanCurrent[0])
        #         for item in succcessors:
        #             sumCost = pacmanCurrent[2]+item[2]
        #             pacmanRoute = pacmanCurrent[1].copy()
        #             pacmanRoute.append(item[1])
        #             fringe.push([item[0], pacmanRoute, sumCost],sumCost)
        # return []
